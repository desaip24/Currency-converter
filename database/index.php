 ...
 <!-- <link rel="stylesheet" type="text/css" href="hover.css"> -->
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
   ...
   <script type="text/javascript">
    fun2()
    {
      alert("Please login to use banking facility");
    }
  </script>
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="php\Converter.php"><a href="#">Converter <span class="glyphicon glyphicon-transfer"></span></a></li>
        <li><a href="php\graph.php">Graph <span class="fa fa-line-chart"></span></a></li>
        <li><a href="" onclick="fun2()">Bank <span class="glyphicon glyphicon-plus"></span></a></li>
