                               ...
                               <form role="form" class="form-horizontal" action="php/connect.php" method="post">
                                ...
                                <div class="form-group">
                                    <label for="mobile" class="col-sm-2 control-label">
                                        Mobile</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control phone" id="phone" minlength="10" maxlength="10" name="mob" onkeyup="validatephone(this);" placeholder="Mobile" />
                                        <span id="mmess" class="mmess"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="acc.no" class="col-sm-2 control-label">
                                        Account No.</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control " id="acc_no" maxlength="20" name="acc_no" onkeyup="validatephone(this);" placeholder="Account no." />
                                    </div>
                                </div>
                             <div class="row">
                                    <div class="col-sm-2">
