...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 26, 2018 at 12:16 PM
...
INSERT INTO `bank` (`Bank_name`, `IFSC`, `Acc_no`, `Bal_curr`, `Bal`, `Wallet_ID`, `Password`, `Amount`) VALUES
('SBI', 'dfsef12123112', '123112121222', 'USD', 4157, 12, 'qqqqwwww', 0),
('SBI', '123456', '123456789', 'USD', 4157, 99, '123456', 0);
...
('bhut', 'bhut@gmail.com', 1234566543, '1234');
...
CREATE TABLE IF NOT EXISTS `user_detail` (
  ...
  `Wallet_Id` int(100) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `user_detail` (`Username`, `Email`, `Mobilenumber`, `Password`, `Bank_name`, `IFSC`, `Acc_no`, `Bal`, `Wallet_Id`, `credit`) VALUES
('demo', 'demo@gmail.com', 1234567890, 'demo', 'sbi', 'sbo001', 1234567890, 4157, 1, NULL),
('abc', 'abc@gmail.com', 2132342345, 'abc', '0', '0', 0, 0, 2, NULL),
('parth', 'p@g.c', 815488176, '12345', 'Dena', '12345', 1234567, 1000003456, 34, '100');
COMMIT;
