  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#">Converter <span class="glyphicon glyphicon-transfer"></span></a></li>
    ...
    <div class="container" id="" style="margin-top: 10px; margin-left: 33%;">
        <table cellspacing="10px">  
           <tr>
            ...
            <tr>
                <td colspan="3">
                    <BUTTON style="margin-left: 0px;" class="btn btn-success btnbtn-lg btn-block" id="Convert" name="Convert" onClick="cur();">Convert</BUTTON> 
                </td>
            </tr>
             <tr><td>&nbsp</td><td>&nbsp</td><td>&nbsp</td></tr>
            ...
            <!-- <tr>
                <td colspan="3">
                    <button class="btn btn-default btn-send btn-block" name="wallet" id="wallet" onclick="transfer();"> <span class="glyphicon glyphicon-send"></span> Add to E-wallet </button>
                </td>
            </tr> -->
