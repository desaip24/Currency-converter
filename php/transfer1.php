...
{
  {
    ...
    $retval1 = mysqli_query($con,$sql1);z
    ?>
<html>
<head>
 <meta charset="UTF-8">
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav ">
        ...
        <li class="active"><a href="#"><span class="glyphicon glyphicon-plus"></span> Bank</a></li>
...
<h1 align="center">click <a href="home.php"> here </a> for updated values</h1>
<br/><br/><br/><br/>
