...
$connect = mysqli_connect("localhost", "root", "", "project") or die("e1"); 
if(isset($_POST['chart']))
{
 ...
 if($from == $to)
 {
  echo "<script type='text/javascript'>alert('Please select different to and from currency to see the variation in graph');</script>";
 }
 else if($to != "inr")
 {
